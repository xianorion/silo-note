...
>
  {/* Header */}
  <Grid container alignItems="center" justifyContent="space-between" sx={{ marginBottom: '12px' }}>
    <Typography
      sx={{
  ...
  <Box
    sx={{
      ...
      padding: '8px',
      borderRadius: '16px',
      backgroundColor: 'rgba(237, 214, 181, 1)',
